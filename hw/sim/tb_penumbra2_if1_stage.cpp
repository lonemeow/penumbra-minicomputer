// Verilator testbench for penumbra2_if1_stage.
//
...
// against the IF1 contract in doc/internals/penumbra2/pipeline-stages.md:
...
#include <cstdio>
#include <cstdint>
#include "Vpenumbra2_if1_stage.h"
#include "verilated.h"
...
static void tick(Vpenumbra2_if1_stage* dut) {
    dut->i_clk = 0; dut->eval();
    dut->i_clk = 1; dut->eval();
}

static void clear(Vpenumbra2_if1_stage* dut) {
...
int main(int argc, char** argv) {
    ...
    Vpenumbra2_if1_stage* dut = new Vpenumbra2_if1_stage;   // RESET_PC = 0
