...
int main(int argc, char** argv) {
    ...
    dut->i_esr   = 0xBBBB0002;
    dut->i_epc   = 0xCCCC0003;
    dut->i_vector_addr = 0xDDDD0004;

    dut->i_sel = 0b00; dut->eval(); check("amux_reg",    dut->o_a_bus, 0xAAAA0001);
    dut->i_sel = 0b01; dut->eval(); check("amux_esr",    dut->o_a_bus, 0xBBBB0002);
    dut->i_sel = 0b10; dut->eval(); check("amux_epc",    dut->o_a_bus, 0xCCCC0003);
