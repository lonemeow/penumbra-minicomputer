...
; mirrors with ADD.  Exactly one `sub r14, r11` (prologue) and one
; `add r14, r11` (epilogue) for the stack adjustment.
define void @huge_frame() {
; CHECK-LABEL: huge_frame:
; CHECK:         lli r11, {{[0-9]+}}
; CHECK-NEXT:    lui r11, 1
; CHECK-NEXT:    sub r14, r11
; CHECK-NOT:     subi r14,
; CHECK-NOT:     sub r14, r11
; CHECK:         add r14, r11
; CHECK-NOT:     addi r14,
; CHECK-NOT:     add r14, r11
; CHECK:         jmp r13
