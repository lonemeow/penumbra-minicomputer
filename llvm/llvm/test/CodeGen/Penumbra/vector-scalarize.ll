...
; CHECK-NEXT:    add r3, 4
; CHECK-NEXT:    stw r11, [r3 + 0]
; CHECK-NEXT:    mov r3, r1
; CHECK-NEXT:    add r3, 8
; CHECK-NEXT:    stw r5, [r3 + 0]
; CHECK-NEXT:    add r1, 12
...
; CHECK-NEXT:    add r4, 2
; CHECK-NEXT:    ldh r11, [r4 + 0]
; CHECK-NEXT:    mov r4, r2
; CHECK-NEXT:    add r4, 4
; CHECK-NEXT:    ldh r4, [r4 + 0]
; CHECK-NEXT:    add r2, 6
; CHECK-NEXT:    ldh r2, [r2 + 0]
; CHECK-NEXT:    ldh r6, [r3 + 0]
; CHECK-NEXT:    mov r13, r3
; CHECK-NEXT:    add r13, 2
...
; CHECK-NEXT:    mov r3, r1
; CHECK-NEXT:    add r3, 2
; CHECK-NEXT:    sth r11, [r3 + 0]
; CHECK-NEXT:    mov r3, r1
; CHECK-NEXT:    add r3, 4
; CHECK-NEXT:    sth r4, [r3 + 0]
; CHECK-NEXT:    add r1, 6
