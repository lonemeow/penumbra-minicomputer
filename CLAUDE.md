...
| Shared package | `rtl/core/penumbra_pkg.sv` | — | REG_*, ALU_*, COND_*, SR_*, ACC_*, VEC_*, SYSDEV_*, SYSREG_*, SYSREG_CACHE_*, CACHE_TYPE_*, UART_*, RAM_BASE, ROM_BASE constants |
