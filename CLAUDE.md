...
4. **Instruction fetch faults** — Detect TLB miss during fetch phase (separate from STALL-based data fault path). Currently fetch-path TLB misses proceed silently with cacheable=0 and no fault.
