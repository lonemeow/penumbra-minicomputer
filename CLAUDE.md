...
- **Datapath:** `doc/core/datapath.md` — three-bus (A/B/R), separate PC unit, 52-bit horizontal microcode, direct-mapped dispatch
...
## Current Status
Architecture design is complete. Next step is writing sample microcode to validate the 52-bit micro-word format, then RTL module decomposition and implementation.
